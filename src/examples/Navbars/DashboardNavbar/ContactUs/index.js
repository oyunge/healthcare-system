            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="card-shadow">
                  <img src="/media/images/logo2.jpg" style={{height:280,width:280}} className="img-fluid" />
                </div>
              </div>
              <div className="col-lg-6">
                    ...
                    <div className="col-lg-4 col-md-4">
                      <div className="card-body d-flex align-items-center c-detail pl-0">
                        ...
                        <LocationOnIcon fontSize='large' style={{color:'#2152ff'}}/>
                          <p className>
                          <a style={{fontWeight:'bold',fontSize:12}} className="text-muted">Kimathi Street , opposite Total petrol station , equity bank building . KIMATHI CHAMBERS 2ND FLOOR RM 9</a>
                            </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-4">
                      <div className="card-body d-flex align-items-center c-detail">
                        ...
                        <AddIcCallIcon fontSize='large' style={{color:'#2152ff'}}/>
                          <p className>
                          <a style={{fontWeight:'bold',fontSize:12}} href="tel:+254713441634" className="text-muted"> +254713441634</a>
                            </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-4">
                      <div className="card-body d-flex align-items-center c-detail">
                        ...
                        <EmailIcon fontSize='large' style={{color:'#2152ff'}}/>
                          <p className>
                          <a style={{fontWeight:'bold',fontSize:12}} href="mailto:info@electrikacomputers.co.ke" className="text-muted"> info@electrikacomputers.co.ke</a>
                          </p>
                        </div>
                      </div>
                    </div>
