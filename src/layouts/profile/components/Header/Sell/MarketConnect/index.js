      ...
      if(currentUser?.isApproved === false){
          ...
          if(!link){
              ...
              try {
                  ...
                  const updatedPWorks = [...data.mcworks, newElement];
          
                  // Update the document with the modified 'pWorks' array
                  await docRef.update({ mcworks: updatedPWorks });
          
                  Swal.fire({
                      icon: 'success',
                      title: 'Success',
                      text: 'Market Connect link added successfully.\nYour Market Connect will be reviewed and approved within 24 hours',
                      customClass: {
                        container: 'my-swal-container', // Replace 'my-swal-container' with your desired class name
                      },
                    });
