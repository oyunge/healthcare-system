        ...
        if(currentUser?.isApproved === false){
            ...
            if(!link){
                ...
                try {
                    ...
                    const updatedPWorks = [...data.pWorks, newElement];
            
                    // Update the document with the modified 'pWorks' array
                    await docRef.update({ pWorks: updatedPWorks });
            
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: 'Page Layer link added successfully.\nYour page layer will be reviewed and approved within 24 hours',
                        customClass: {
                          container: 'my-swal-container', // Replace 'my-swal-container' with your desired class name
                        },
                      });
